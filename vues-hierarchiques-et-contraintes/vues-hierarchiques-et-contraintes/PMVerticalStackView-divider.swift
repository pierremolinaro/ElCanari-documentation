//
//  PMVerticalStackView-divider.swift
//  essai-gridview
//
...
extension PMVerticalStackView {
  ...
  private final class HorizontalDivider : NSView {
    ...
    init (drawFrame inDrawFrame : Bool, canResizeWindow inFlag : Bool) {
    ...
    private static let mLayoutSettings = PMViewLayoutSettings (
    ...
    override var pmLayoutSettings : PMViewLayoutSettings { Self.mLayoutSettings }
    ...
    override func mouseDown (with inEvent : NSEvent) {
      if let vStack = self.superview as? PMVerticalStackView {
        if vStack.isFlipped {
    ...
    override func updateConstraints () {
      if let vStack = self.superview as? PMVerticalStackView {
        ...
        let priority : PMLayoutConstraintPriority = self.mCanResizeWindow ? .canResizeWindow : .cannotResizeWindow
