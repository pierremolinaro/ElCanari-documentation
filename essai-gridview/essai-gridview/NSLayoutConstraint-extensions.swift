...
@MainActor extension Array where Element == NSLayoutConstraint {
  ...
  mutating func add (requiresWidthOf inView1 : NSView,
  ...
  mutating func add (widthOf inView : NSView,
                     ...
                     priority inPriority : PMLayoutConstraintPriority = .highest) {
  ...
  mutating func add (requiresHeightOf inView1 : NSView,
  ...
  mutating func add (requiresLeftOf inView1 : NSView,
 ...
 //--------------------------------------------------------------------------------------------------------------------
  ...
  mutating func add (requiresRightOf inView1 : NSView,
                     equalToRightOf inView2 : NSView,
                     plus inOffset : CGFloat = 0.0) {
    let c = inView1.rightAnchor.constraint (equalTo: inView2.rightAnchor, constant: inOffset)
    c.priority = PMLayoutConstraintPriority.highest.cocoaPriority
    self.append (c)
  }
  ...
  mutating func add (requiresTopOf inView1 : NSView,
  ...
  mutating func add (requiresBottomOf inView1 : NSView,
                     equalToTopOf inView2 : NSView,
                     plus inOffset : CGFloat = 0.0) {
  // Vertical Axis is from to top to bottom
...
//    let c = inView1.bottomAnchor.constraint (lessThanOrEqualTo: inView2.bottomAnchor, constant: -inOffset)
  ...
  mutating func add (requiresLastBaselineOf inView1 : NSView,
  ...
  mutating func add (requiresCenterXOf inView1 : NSView, equalToCenterXOf inView2 : NSView) {
  ...
  mutating func add (requiresCenterYOf inView1 : NSView, equalToCenterYOf inView2 : NSView) {
